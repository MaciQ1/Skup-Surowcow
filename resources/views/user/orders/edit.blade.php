...
<body>
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-6">
                <form method="POST" action="{{ route('user.orders.update', $order->id) }}" class="needs-validation"
                    novalidate>
                    @csrf
                    @method('PUT')
                    <div class="form-group mb-2">
                        <label for="quantity_number" class="form-label">Ilość (w tonach)</label>
                        <input id="quantity_number" name="quantity" type="number" min="0.1" max="100"
                            step="0.1" class="form-control @if ($errors->first('quantity')) is-invalid @endif"
